...
//     public SolarSystemV0(final FocalPoint focalPoint) {
...
//         final double updated_x = updated_x_offset + satellite.getFocalPoint().getCoordinates().initialPositionX();
//         final double updated_y = updated_y_offset + satellite.getFocalPoint().getCoordinates().initialPositionY();
...
//         final double diff_x = updated_x - satellite.getFocalPoint().getCoordinates().initialPositionX();
//         final double diff_y = updated_y - satellite.getFocalPoint().getCoordinates().initialPositionY();

//         final double x_change = (diff_x * cos) - (diff_y * sin);
//         final double y_change = (diff_x * sin) + (diff_y * cos);

//         final double new_x = x_change + satellite.getFocalPoint().getCoordinates().initialPositionX();
//         final double new_y = y_change + satellite.getFocalPoint().getCoordinates().initialPositionY();
